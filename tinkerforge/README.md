...
- tinkerforge-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- tinkerforge-ui: main application module, development time
- tinkerforge-production: module that produces a production mode WAR for deployment
